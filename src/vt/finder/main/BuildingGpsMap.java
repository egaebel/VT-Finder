...
/**
 * Contains a static Map of Virginia Tech building GPS coordinates that is 
 ...
 *                  then call the overriden setupBuildingGpsMap method using super.
 *                      i.e. super.setupBuildingGpsMap().
 *  
...
public class BuildingGpsMap {
     ...
     *          between the two if desired.
     */
    private static Map<String, Point> buildings;
    /**
     * Boolean value indicating whether the Map has been initialized or not.
     */
     ...
     * 
     */
    private static void setupBuildingGpsMap () {
     ...
     */
    public static Point get(String key) throws BuildingNotFoundException {
